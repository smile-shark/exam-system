...
export default{
    ...
    insertChapter:api+"/teacher/chapter/insert/insertChapters",
    updateCourse:api+"/teacher/course/update/updateCourse",
    deleteCourseByCourseId:api+"/teacher/course/delete/deleteCourseByCourseId",
    insertSubsection:api+"/teacher/subsection/insert/insertSubsection",
    updateChapter:api+"/teacher/chapter/update/updateChapter",
    deleteChapterByChapterId:api+"/teacher/chapter/delete/deleteChapter",
    updateSubsection:api+"/teacher/subsection/update/updateSubsection",
