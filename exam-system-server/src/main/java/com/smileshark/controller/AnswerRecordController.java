...
public class AnswerRecordController {
    ...
    @RequestMapping("/student/list/selectAnswerRecordByStudentIdIsFalse")
    public String selectAnswerRecordByStudentIdIsFalse(@RequestBody RequestParams requestParams) {
        return answerRecordService.selectAnswerRecordByStudentIdIsFalse(requestParams);
    }
}
